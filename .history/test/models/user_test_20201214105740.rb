...
class UserTest < ActiveSupport::TestCase
  ...
  # end
   def setup
    @user = User.new(first_name: "Simon", last_name: "Sinek", email: "simon@yahoo.com", password: "simonsinek", avatar:fixture_file_upload(Rails.root.join('public', 'image1.jpg'), 'image/j') )
  end
