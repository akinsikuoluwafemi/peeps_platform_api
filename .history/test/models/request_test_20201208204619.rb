...
class RequestTest < ActiveSupport::TestCase
  ...
  test "lat should be present" do
    @request.lat = " "
    assert_not @request.valid?, "lat should be present"

  end

  test "lng should be present" do
    @request.lng = " "
    assert_not @request.valid?, "lng should be present"

  end

  test "request_type should be present" do
    @request.request_type = " "
    assert_not @request.valid?, "request_type should be present"
