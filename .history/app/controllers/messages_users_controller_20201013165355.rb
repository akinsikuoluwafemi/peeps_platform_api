...
#     if MessagesUser.between(messages_user_params).present?
#         @messages_user = MessagesUser.between(messages_user_params).first
#         render json: @messages_user, status: :created, location: @messages_user
...
# end
  ...
  private
    ...
    def messages_user_params
      ...
      params.require(:messages_user).permit(:message_id, :recipient_id)
